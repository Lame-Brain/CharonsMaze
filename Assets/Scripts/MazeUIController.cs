...
public class MazeUIController : MonoBehaviour
{
    ...
    {
        story = new string[6];
        story[0] = "As you pick up the rune, a voice speaks from the very air. It is little more than a whisper on the breeze, but you can make it out nonetheless. <color=blue>''So, not just a treasure hunter after all, You are blood of my blood-that-once-was. Do you know what you have just taken? Were you sent by Charon? Do you know what doom you have been cursed to?''</color>\n\n<color=lightgrey>''Who’s there!?''</color> You demand, but the voice is gone and only silence remains.";
        story[1] = "You find another Rune, and as you pick it up, you hear the voice again. <color=blue>''Once, long ago, I too lived, and died, and stood before Charon. I offered him the toll, but instead of taking it, he told me of this Labyrinth. Have you guessed the truth of the Labyrinth yet? Have you guessed why a Ferryman of Hades needs a Labyrinth to trap souls?''</color>\n\nYou spin in a circle, but none is there. <color=lightgrey>''Who is this!? Are you the Ghost? The Ancestor Spirit?''</color> but once again the voice is gone.";
        story[2] = "This time, as you take the Rune, you brace yourself for the voice. As expected, it speaks, answering your question from last time: <color=blue>''Am I the Dark Spirit? Yes and no. I am what the Ghost once was, and the Ghost is what I once was. But I grow weak and the Ghost grows strong. I have forgotten much, but I remember this: Stop the Dark Spirit from escaping at any cost!''</color>\n\n<color=lightgrey>''Tell me more about the Labyrinth! Tell me how to escape!''</color> You shout, well aware that you will receive no answer until you find another Rune.";
        story[3] = "<color=lightgrey>''Tell me about the Labyrinth, and tell me what I must do.''</color> You declare, just before taking the last Rune.\n\n<color=blue>''Do not trust Charon. This is his Labyrinth, and he is responsible for the tortures that shaped the Dark Spirit my other half has become! The Runes are me, and tied to our bloodline. Bring them to Charon and find out what he wants, but remember; he cannot act upon the Runes himself, he needs to use you as his agent. Defy him! Overcome him! Do not trust him as I once did!''</color>\n\nThe voice fades as before. You have all four Runes now. Time to seek out Charon again.";
